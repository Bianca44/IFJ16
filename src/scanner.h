...
char *token_names[TOKENS_COUNT] =
    { "LEXICAL_ERROR", "ID", "KEYWORD", "INTEGER", "FLOAT", "ADD", "SUB", "MUL", "DIV",
	...
	"NOT_EQUAL",
    "LESS_EQUAL", "LESS", "GREATER_EQUAL", "GREATER", "EQUAL", "SPECIAL_ID", "BOOLEAN",
    "BREAK", "CLASS", "CONTINUE", "DO", "DOUBLE", "ELSE", "FALSE",
    "FOR", "IF", "INT", "RETURN", "STRING", "STATIC", "TRUE", "VOID", "WHILE"
};
...
enum tokens { LEXICAL_ERROR, ID, KEYWORD, INTEGER, FLOAT, ADD, SUB, MUL, DIV, SEMICOLON,
    ...
    LESS_EQUAL, LESS, GREATER_EQUAL, GREATER, EQUAL, SPECIAL_ID, BOOLEAN, BREAK, CLASS,
    CONTINUE, DO, DOUBLE, ELSE, FALSE, FOR, IF, INT, RETURN, STRING, STATIC, TRUE, VOID, WHILE };
